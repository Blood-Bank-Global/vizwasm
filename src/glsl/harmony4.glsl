...
float dx = vx / 2.0 *cos(src_coord0.y * 8 * M_PI + frame/30.0) * cos(src_coord0.y * 20 * M_PI + frame/300.0) + 1.2 * vx;
float dy = vy / 2.0 *cos(src_coord0.x * 8 * M_PI + frame/30.0) + 1.2 * vy;
