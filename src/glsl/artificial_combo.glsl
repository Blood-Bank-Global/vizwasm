...
#define MARIA_TEX src_tex0
#define MARIA_RES iResolution0
#define MARIA_COORDS src_coord0
#define TITLE_TEX src_tex1
#define TITLE_RES iResolution1
#define TITLE_COORDS src_coord1
...
color = texture(MARIA_TEX, MARIA_COORDS);

vec4 top_color = texture(TITLE_TEX, TITLE_COORDS + vec2(0.0, 0.0));
